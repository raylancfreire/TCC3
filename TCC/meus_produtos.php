    ...
    <div class="container">
        ...
        ?>
            <div style="border: solid 2px black">
                ...
                <a href="javascript:void(0);" style="margin-left: 20px;" onclick="openPopupDelete(<?php echo $produto['id_produto']; ?>, '<?php echo $produto['nome_produto']; ?>');" class="btn btn-danger">Excluir Produto</a>
                <br>
                <br>
            </div>
        <?php endforeach; ?>
    ...
    <script>
        function openPopup(produtoId, nome, descricao, marca, quantidade, preco) {
            ...
            function updateProduto() {
                ...
                // Envie os valores para o servidor usando AJAX
                $.ajax({
                    url: 'CRUD/atualizar_produtos.php', // URL do arquivo PHP para atualização no banco de dados
                    type: 'POST',
                    data: {
                        produtoId: produtoId,
