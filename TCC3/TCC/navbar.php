      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <?php if ($tipoUsuario === 'empresa') : ?>
              <a class="nav-link" href="pedidos.php" style="margin-right: 70px; width: 190px; border: 1.5px solid black; border-radius: 5px;">Pedidos</a>
            <?php else : ?>
              <a class="nav-link" href="pedidos.php" style="margin-right: 70px; width: 190px; border: 1.5px solid black; border-radius: 5px;">Catalogo</a>
            <?php endif; ?>
          </li>
          <li class="nav-item">
            <?php if ($tipoUsuario === 'empresa') : ?>
